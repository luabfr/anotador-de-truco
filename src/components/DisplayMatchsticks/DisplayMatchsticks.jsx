	...
	return (
		<>
			<DisplayMatchsticksContainer colorModeSelected={colorModeSelected} borderBottom>
				<StickGroup>
					<StickTop colorModeSelected={colorModeSelected} team={team} on={teamPoints > 0}/>
					<StickRight colorModeSelected={colorModeSelected} team={team} on={teamPoints > 1} />
					<StickBottom colorModeSelected={colorModeSelected} team={team} on={teamPoints > 2} />
					<StickLeft colorModeSelected={colorModeSelected} team={team} on={teamPoints > 3} />
					<StickDiagonal colorModeSelected={colorModeSelected} team={team} on={teamPoints > 4} />
				</StickGroup>

				<StickGroup>
					<StickTop colorModeSelected={colorModeSelected} team={team} on={teamPoints > 5} />
					<StickRight colorModeSelected={colorModeSelected} team={team} on={teamPoints > 6} />
					<StickBottom colorModeSelected={colorModeSelected} team={team} on={teamPoints > 7} />
					<StickLeft colorModeSelected={colorModeSelected} team={team} on={teamPoints > 8} />
					<StickDiagonal colorModeSelected={colorModeSelected} team={team} on={teamPoints > 9} />
				</StickGroup>

				<StickGroup>
					<StickTop colorModeSelected={colorModeSelected} team={team} on={teamPoints > 10} />
					<StickRight colorModeSelected={colorModeSelected} team={team} on={teamPoints > 11} />
					<StickBottom colorModeSelected={colorModeSelected} team={team} on={teamPoints > 12} />
					<StickLeft colorModeSelected={colorModeSelected} team={team} on={teamPoints > 13} />
					<StickDiagonal colorModeSelected={colorModeSelected} team={team} on={teamPoints > 14} />
				</StickGroup>
